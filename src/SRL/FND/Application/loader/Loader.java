 ...
 */
package SRL.FND.Application.loader;
...
public class Loader extends Preloader {
    ...
    public void init(){
        try {
            view = FXMLLoader.load(getClass().getResource("/SRL/FND/Application/loader/loader.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void start(Stage primary){
        ...
        //  scene.getStylesheets().add(getClass().getResource("/SRL/FND/theme/css/fonts.css").toExternalForm());
