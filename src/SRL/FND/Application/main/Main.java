...
import SRL.FND.Application.global.factory.AlertCell;
...
/**
 * @author Gleidson Neves da Silveira | gleidisonmt@gmail.com Create on 08/10/2018 Version 2.0
 */
public class Main implements Initializable {
    ...
    private String path = "/SRL/Dashboard/theme/css/";
...
//        body.setContent(ViewManager.getInstance().get("dashboard"));
        ...
        //drawer.setPopStylesheet(getClass().getResource("/SRL/FND/theme/css/popover.css"));
    }
...
//            avatar.setStrokeWidth(0);
            ...
            drawer.getChildren().addAll(searchBox);
            searchBox.toBack();
            // info.toBack();
//            avatar.toBack();
//            avatar.setStrokeWidth(2);
    ...
    private void addSubPop() throws Exception {
        popup.setContentNode(FXMLLoader.load(getClass().getResource("/SRL/FND/Application/main/Popover.fxml")));
...
//        popup.getRoot().getStylesheets().add(getClass().getResource("/com/gn/theme/css/poplight.css").toExternalForm());
    ...
    private void addEvent(Node node) {
        ...
        scrollPane.getStylesheets().add(getClass().getResource("/SRL/FND/theme/css/custom-scroll.css").toExternalForm());
...
//        Popover.ctrl.options.getChildren().clear();
    ...
    private void loadContentPopup() {
        try {
            popContent = FXMLLoader.load(getClass().getResource("/SRL/FND/Application/main/Config.fxml"));
            popConfig.getRoot().getStylesheets().add(getClass().getResource("/SRL/FND/theme/css/poplight.css").toExternalForm());
    ...
    private void clearText() {
     ...
     @FXML
    private void OpenSmsTemplate()
    {
        title.setText("SMS Templates");
        body.setContent(ViewManager.getInstance().get("SmsTemplate"));
    }

    @FXML
    private void OpenSendSMS() {
        title.setText("SMS Templates");
        body.setContent(ViewManager.getInstance().get("SendSMS"));
    }
    ...
    private void openNotification() {
        if (!pop.isShowing()) {
            ...
            avatar1.setImage(new Image(getClass().getResource("/SRL/FND/media/warning-35.png").toExternalForm()));
            avatar2.setImage(new Image(getClass().getResource("/SRL/FND/media/error-35.png").toExternalForm()));
            avatar3.setImage(new Image(getClass().getResource("/SRL/FND/media/notification-35.png").toExternalForm()));
            ...
            listView.getStylesheets().add(getClass().getResource("/SRL/FND/theme/css/custom-scroll.css").toExternalForm());

            pop.getRoot().getStylesheets().add(getClass().getResource("/SRL/FND/theme/css/poplight.css").toExternalForm());
